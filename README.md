...
use bitcoin_send_tx_p2p::send_tx_p2p_over_clearnet;
use hex::FromHex;
...
async fn main() -> Result<()> {
    ...
    send_tx_p2p_over_clearnet("127.0.0.1:8333".parse()?, tx, None).await
}
```
...
use bitcoin::consensus::encode::deserialize;
use bitcoin::Network;
use bitcoin_send_tx_p2p::{send_tx_p2p_over_tor, Config};
use hex::FromHex;
